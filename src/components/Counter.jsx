...
export default function Counter() {
  ...
  return (
    <div className="p-6 bg-white border border-gray-200 rounded-md max-w-sm mx-auto">
      ...
      <div className="flex gap-2 justify-center">
        ...
        <button
          onClick={reset}
          className="px-3 py-2 bg-white border border-gray-300 rounded font-medium text-sm text-gray-700 hover:bg-gray-50"
        >
          Reset
        </button>
      </div>
